...
extension UILabel {
    ...
    private
    func addAttr(txts: NSMutableAttributedString, _ color: UIColor, _ font: UIFont!, _ range: NSRange) {
    ...
    private
    func addAttr(_ txts: NSMutableAttributedString, _ attr: String, _ color: UIColor, _ font: UIFont!) {
